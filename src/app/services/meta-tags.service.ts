...
export class MetaTagsService {
  ...
  public setMetas(title: string, desc: string) {
    ...
    this.metaService.addTags([
      ...
      { itemprop: 'image', content: 'https://le-parti.github.io/le-journal/assets/img/logo.png' },
      
      { name: 'twitter:image', content: 'https://le-parti.github.io/le-journal/assets/img/logo.png' },
      ...
      { property: 'og:image', content: `https://le-parti.github.io/le-journal/assets/img/logo.png` },
